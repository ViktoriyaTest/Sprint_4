...
public class QuestionsAnswersTest extends WebDriver {

    private final String expectedText;
    private final String questionHeader;

    public QuestionsAnswersTest(String questionHeader, String expectedText) {
    ...
    public void checkQuestionsAboutImportant() {
        HomePage objHomePageScooter = new HomePage(driver);
